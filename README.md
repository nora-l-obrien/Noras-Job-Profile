...
- Software and Tools: RStudio, Jupyter Notebooks, Microsoft Excel.
  ...
  REPOSITORY STRUCTURE AND FILE BREAKDOWN:
- Applied Statistical Analyses(R)
   > EPS702Final_Exam.R: R script performing foundational statistical procedures, hypothesis testing, and quantitative data analysis.
   
   > EPS703Final_Exam.R: Advanced R script focusing on multivariate techniques, regression modeling, and statistical inference.
   
- Python Data Science and Modeling
   > EPS721FINAL_O'Brien.ipynb: Comprehensive Jupyter Notebook implementing end-to-end data processing, exploratoy data analysis(EDA), data cleaning, and statistical modeling in Python.
